...
public class compNewsFeed_Home extends BaseClass {
	...
	public void Edit_Post() throws IOException, InterruptedException  {
		...
		cn.textContentField("Editing Post");
...
//							Assert.assertEquals(expected_Text4, actual_Text4);
							...
							WebElement CommentBookmark = driver.findElement(By.xpath("(//span[@class='pdngHXS pointer'][normalize-space()='Comment'])[1]"));
							...
							WebElement ReplyComment = driver.findElement(By.xpath("//span[@class='primaryTxt headingSM pdngHLG pointer']"));
							ReplyComment.click();
...
//						Assert.assertEquals(expected_Text3, actual_Text3);
						...
						WebElement ShareBookmark = driver.findElement(By.xpath("(//span[contains(text(),'Share')])[1]"));
	...
	//Scroll Down The homePage Feed Until Load More Text display and Click on It.
		public void ScrollFeedUntilLoadmore() throws IOException, InterruptedException  {
			...
			Thread.sleep(1000);
			JavascriptExecutor js = (JavascriptExecutor) driver;
			WebElement LoadMore = driver.findElement(By.xpath("//button[normalize-space()='See More']"));
